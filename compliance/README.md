...
- **`branches.md`** — list of physical branch offices (6 open, 3 closed July 2026) — the GBP claim list.
...
- **Total branches:** 6 open (Uniondale NY HQ + Branchburg NJ + Bay Shore NY + Ft. Lauderdale FL + Buckeye AZ + Excelsior MN). Jamaica NY, Wantagh NY, and Orlando FL closed July 2026 — do not reference as current offices. See `branches.md`.
